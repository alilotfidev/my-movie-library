const showPopup = (movie) => {
      ...
      <div class="details">
          <div class="headlines">
              ...
              <div class="buttons">
                  ...
                  <a href="https://imdb.com/title/${movie.imdb_id}" class="button" target="_blank"
  ...
  mainElement.classList.add('movie-details-popup');
  mainElement.innerHTML = html;
  document.querySelector('body').appendChild(mainElement);
  setTimeout(() => {
    document
      .querySelector('.movie-details-popup')
    ...
    document
      ...
      .addEventListener('click', () => {
        ...
        document.querySelector('.movie-details-popup').remove();
      });
  }, 300);
};
...
//  <div class="movie-details-popup"> </div>
